...
export interface TwoColumnLayoutProps {
    children: ReactNode; // Contenido para el lado izquierdo (ej. el formulario)
...
export const TwoColumnLayout: FC<TwoColumnLayoutProps> = ({
    ...
    return (
        ...
        <div className={clsx("flex flex-col md:flex-row h-screen w-full items-center justify-center bg-gray-100 max-w-[1366px]", containerClassName)}>
            ...
            <div className={clsx("w-full md:w-1/2 lg:w-1/2 flex justify-center items-center p-4", leftContentClassName)}>
                {children}
            </div>
            ...
            <div className={clsx(
                "hidden md:block md:w-1/2 lg:w-1/2", // Oculto en móvil, visible en md y lg
